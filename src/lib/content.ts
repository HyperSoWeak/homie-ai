...
export const content: Record<"en" | "zh-tw", Content> = {
  ...
  "zh-tw": {
    ...
    hero: {
      ...
      subtitle: "認識 Hoobi：每天依照你的能量、情緒、工作量與突發事件幫你自動調整排程的 AI 夥伴",
      tagline: "你終於不必再遷就行事曆，而是讓 Hoobi 幫你讓行事曆開始遷就你的生活。",
      cta: "加入等待名單",
    },
    problem: {
      title: "你不需要更多工具，你需要的是「懂你」的夥伴",
      items: [
        {
          title: "無止盡的重排",
          desc: "每週花好幾個小時在重新排程。",
    ...
    features: {
      ...
      items: [
        ...
        {
          title: "智慧排程",
          desc: "設計三套專屬「你」的行事曆，選一個最適合你當月節奏的版本。",
        },
        {
          title: "像聊天一樣安排和調整行程",
